...
for  href in list_link:
    ...
    joblist.append(JobListing(title=title,salary=salary,employment_type=employment_type,description=description,city=city,responded=False,response="",publicationdate=date))
